...
>
> **코드로 이어서 할 것**: [Phase 44](plans/phase_44.md)의 **T4 (a)·(d)(캘린더 크기·뭉개짐) ·
> T1(뽀모도로 알람) · T2(카드 드래그) · T3(메모 색 — 마이그레이션 1건 필요)**.
> T4 (b)·(c)는 2026-07-27에 끝냈다. [Phase 43](plans/phase_43.md)은
