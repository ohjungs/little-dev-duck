...
> ## 📌 다음 세션은 여기서 시작한다 (2026-07-26 23:5x 기준)
>
> **막힌 것 · 사용자만 할 수 있는 것부터** ([PENDING.md](loop-eng/PENDING.md) 상세):
> 1. **Supabase → Authentication → Providers → Email 켜기** — Phase 41 T1이 배포됐지만
>    **꺼진 상태**라 폼이 안내 문구만 낸다.
...
>
> **코드로 이어서 할 것**: [Phase 41](plans/phase_41.md) **T2(비밀번호 정책·상한) · T3(재설정)**.
> **T3가 없으면 비밀번호를 잊은 사용자가 영구 잠긴다**(DECISIONS 12번이 비용으로 적어 둔 항목).
