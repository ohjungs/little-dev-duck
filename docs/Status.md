...
>
> **코드로 이어서 할 것**: [Phase 44](plans/phase_44.md) **T3(메모 색)** — 다만 `memos`에
> `color` 컬럼을 더하는 **마이그레이션 1건**이 필요해 대기 중인 것이 다섯 개가 된다.
> 그 뒤는 [Phase 45](plans/phase_45.md) 이후. T1·T2·T4는 2026-07-27에 끝냈다. [Phase 43](plans/phase_43.md)은
