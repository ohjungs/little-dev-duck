...
>
> **코드로 이어서 할 것**: [Phase 42](plans/phase_42.md)는 **T5(로고 크기)만 남았다** —
> 그건 영상 재인코딩이 필요해 도구 확인이 먼저다. 그 뒤는 [Phase 43](plans/phase_43.md)
> (도구 모음을 4개로 줄이기 — T1이 임시로 막아 둔 근본 원인).
> T1·T2·T3·T4·T6·T7은 2026-07-27에 끝냈다.
